...
def upgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS ix_planned_payments_payment_date ON planned_payments") # <-- ИЗМЕНЕНИЕ ЗДЕСЬ
    op.execute("DROP TABLE IF EXISTS planned_payments") # <-- ЭТА СТРОКА УЖЕ БЫЛА ИЗМЕНЕНА
